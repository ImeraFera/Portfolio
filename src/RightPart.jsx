                ...
                <div className="row align-items-center justify-content-center">
                    ...
                    <div className="container">
                        <div className="row justify-content-center ms-auto">
                            <img src="/img/js.png" className="pt-3 img-hover" style={{ maxWidth: '75px', minWidth: '50px' }} alt="" />
                            <img src="/img/java.png" className="pt-3 img-hover" style={{ maxWidth: '75px', minWidth: '50px' }} alt="" />
                            <img src="/img/html.png" className="pt-3 img-hover" style={{ maxWidth: '75px', minWidth: '50px' }} alt="" />
                            <img src="/img/css.png" className="pt-3 img-hover" style={{ maxWidth: '75px', minWidth: '50px' }} alt="" />
                            <img src="/img/nodejs.png" className="pt-3 img-hover" style={{ maxWidth: '75px', minWidth: '50px' }} alt="" />
                        </div>
                    </div>
                    <div className="container">
                    ...
                    <div className="container" id="projectContainer">
                        <p className="fs-5 text-start project" >
                            <img src="/img/project.gif" style={{ maxWidth: '50px' }} alt="" />
